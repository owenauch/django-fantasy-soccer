...
# get match ids
schedule_url = schedule_url_front + todays_date_string + schedule_url_back
...
for id in match_ids:
    ...
    for team in teams:
        ...
        for player in players:
            ...
            MatchStat.objects.filter(match_date=todays_date_string, player_id=id).delete()
